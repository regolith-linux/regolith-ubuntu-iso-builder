...
export RELEASE_NOTES_URL="https://regolith-desktop.com/docs/reference/Releases/regolith-3.0-release-notes/"
...
function customize_image() {
    ...
    echo -e "\ndeb [arch=amd64 signed-by=/usr/share/keyrings/regolith-archive-keyring.gpg] https://regolith-desktop.org/testing-ubuntu-jammy-amd64 jammy main" | sudo tee /etc/apt/sources.list.d/regolith.list
