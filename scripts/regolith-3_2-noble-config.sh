...
export TARGET_DISTRO_VERSION="3.2.0"
...
export RELEASE_NOTES_URL="https://regolith-desktop.com/docs/reference/Releases/regolith-3.2-release-notes/"
...
function customize_image() {
    ...
    wget -qO - http://archive.regolith-desktop.org/regolith.key | gpg --dearmor | sudo tee /usr/share/keyrings/regolith-archive-keyring.gpg
    echo -e "deb [arch=amd64 signed-by=/usr/share/keyrings/regolith-archive-keyring.gpg] http://archive.regolith-desktop.org/ubuntu/stable noble v3_2" | sudo tee /etc/apt/sources.list.d/regolith.list
